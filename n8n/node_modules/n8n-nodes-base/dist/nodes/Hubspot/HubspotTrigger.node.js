        ...
        this.webhookMethods = {
            default: {
                async checkExists() {
                    ...
                    const { appId } = this.getCredentials('hubspotDeveloperApi');
                    try {
