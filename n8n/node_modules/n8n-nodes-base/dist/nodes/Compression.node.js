            ...
            if (operation === 'decompress') {
                ...
                for (const [index, binaryPropertyName] of binaryPropertyNames.entries()) {
                    ...
                    if (binaryData.fileExtension === 'zip') {
                        const files = await unzip(Buffer.from(binaryData.data, n8n_core_1.BINARY_ENCODING));
                        ...
                        const file = await gunzip(Buffer.from(binaryData.data, n8n_core_1.BINARY_ENCODING));
                ...
                for (const [index, binaryPropertyName] of binaryPropertyNames.entries()) {
                    ...
                    if (outputFormat === 'zip') {
                        zipData[binaryData.fileName] = [
                            Buffer.from(binaryData.data, n8n_core_1.BINARY_ENCODING),
                            {
                        ...
                        const outputPrefix = this.getNodeParameter('outputPrefix', 0);
                        const data = await gzip(Buffer.from(binaryData.data, n8n_core_1.BINARY_ENCODING));
