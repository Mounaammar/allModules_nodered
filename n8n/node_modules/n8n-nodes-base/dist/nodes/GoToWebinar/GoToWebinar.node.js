...
class GoToWebinar {
    ...
    async execute() {
        ...
        let responseData;
        const returnData = [];
        const { oauthTokenData } = this.getCredentials('goToWebinarOAuth2Api');
                ...
                if (resource === 'attendee') {
                    ...
                    if (operation === 'create') {
                        ...
                        if (updateFields.times) {
                            ...
                            updateFields = lodash_1.omit(updateFields, ['times']);
                        }
