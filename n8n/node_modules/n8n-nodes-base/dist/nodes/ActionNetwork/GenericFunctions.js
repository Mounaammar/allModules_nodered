...
async function actionNetworkApiRequest(method, endpoint, body = {}, qs = {}) {
    const credentials = this.getCredentials('actionNetworkApi');
...
exports.isPrimary = (field) => field.primary;
...
exports.simplifyResponse = (response, resource) => {
    if (resource === 'person') {
