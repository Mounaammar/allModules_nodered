...
import { IDataObject, INodeProperties, IPollFunctions } from 'n8n-workflow';
...
export declare function formatBlocks(blocks: IDataObject[]): {
    ...
    object: string;
    type: string | number | boolean | object | IDataObject | import("n8n-workflow").GenericValue[] | IDataObject[] | null | undefined;
}[];
export declare function mapProperties(properties: IDataObject[], timezone: string): IDataObject;
export declare function mapSorting(data: [{
    key: string;
    type: string;
    direction: string;
    timestamp: boolean;
...
export declare function mapFilters(filters: IDataObject[], timezone: string): IDataObject;
export declare function simplifyProperties(properties: any): any;
export declare function simplifyObjects(objects: any): IDataObject[];
