        ...
        for (let i = 0; i < length; i++) {
            if (resource === 'receipt') {
                if (operation === 'predict') {
                    ...
                    if (rawData === false) {
                        responseData = GenericFunctions_1.cleanData(responseData.predictions);
                    }
                }
            }
            if (resource === 'invoice') {
                if (operation === 'predict') {
                    ...
                    responseData = await GenericFunctions_1.mindeeApiRequest.call(this, 'POST', `/invoices/v1/predict`, {}, {}, {
                        formData: {
                            file: {
                                value: Buffer.from(binaryData.data, n8n_core_1.BINARY_ENCODING),
                                options: {
