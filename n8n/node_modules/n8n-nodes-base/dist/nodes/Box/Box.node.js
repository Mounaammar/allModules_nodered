        ...
        for (let i = 0; i < length; i++) {
            if (resource === 'file') {
                ...
                if (operation === 'download') {
                    ...
                    let mimeType;
                    responseData = await GenericFunctions_1.boxApiRequest.call(this, 'GET', `/files/${fileId}/content`, {}, {}, undefined, { resolveWithFullResponse: true });
                    const newItem = {
                        json: items[i].json,
                        binary: {},
                    };
                ...
                if (operation === 'share') {
                    ...
                    const body = Object.assign({ accessible_by: {}, item: {
                            id: fileId,
                            type: 'file',
                        }, role: (role === 'coOwner') ? 'co-owner' : change_case_1.noCase(role) }, options);
                    if (body.fields) {
                ...
                if (operation === 'upload') {
                    ...
                    if (isBinaryData) {
                        ...
                        body['file'] = {
                            value: Buffer.from(binaryData.data, n8n_core_1.BINARY_ENCODING),
                            options: {
