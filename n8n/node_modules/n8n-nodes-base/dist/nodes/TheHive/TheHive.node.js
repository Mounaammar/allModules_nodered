        ...
        this.methods = {
            loadOptions: {
                ...
                async loadObservableOptions() {
                    var _a;
                    const version = (_a = this.getCredentials('theHiveApi')) === null || _a === void 0 ? void 0 : _a.apiVersion;
                    const options = [
                ...
                if (operation === 'create') {
                    ...
                    if (body.dataType === 'file') {
                        ...
                        options = {
                            formData: {
                                attachment: {
                                    value: buffer_1.Buffer.from(binaryData.data, n8n_core_1.BINARY_ENCODING),
                                    options: {
