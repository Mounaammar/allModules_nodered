...
class MongoDb {
    ...
    async execute() {
        const { database, connectionString } = mongo_node_utils_1.validateAndResolveMongoCredentials(this, this.getCredentials('mongoDb'));
        ...
        if (operation === 'delete') {
            ...
            let query = mdb
                .collection(this.getNodeParameter('collection', 0))
                .find(JSON.parse(this.getNodeParameter('query', 0)));
