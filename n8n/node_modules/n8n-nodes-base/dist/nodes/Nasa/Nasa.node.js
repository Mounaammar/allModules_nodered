        ...
        for (let i = 0; i < items.length; i++) {
            ...
            if (resource === 'astronomyPictureOfTheDay') {
                if (operation === 'get') {
                    ...
                    qs.date = moment(additionalFields.date).format('YYYY-MM-DD') || moment().format('YYYY-MM-DD');
                }
            }
            if (resource === 'asteroidNeoFeed') {
                if (operation === 'get') {
                    ...
                    qs.start_date = moment(additionalFields.startDate).format('YYYY-MM-DD') || currentDate;
                    qs.end_date = moment(additionalFields.endDate).format('YYYY-MM-DD') || currentDate;
                }
            }
