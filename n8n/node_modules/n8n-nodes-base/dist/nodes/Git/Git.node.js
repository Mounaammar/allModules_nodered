...
class Git {
    ...
    async execute() {
        ...
        const prepareRepository = (repositoryPath) => {
            const authentication = this.getNodeParameter('authentication', 0);
            if (authentication === 'gitPassword') {
                const gitCredentials = this.getCredentials('gitPassword');
            ...
            try {
                ...
                if (operation === 'add') {
                    ...
                    if (options.repository) {
                        const targetRepository = prepareRepository(options.targetRepository);
                        ...
                        if (authentication === 'gitPassword') {
                            ...
                            targetRepository = prepareRepository(targetRepository);
                            await git.push(targetRepository);
                        }
                        else {
                            await git.push();
