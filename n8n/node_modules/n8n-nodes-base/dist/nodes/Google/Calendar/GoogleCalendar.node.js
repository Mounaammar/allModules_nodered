                ...
                if (resource === 'event') {
                    if (operation === 'create') {
                        ...
                        if (additionalFields.rrule) {
                            ...
                            if (additionalFields.repeatUntil) {
                                (_c = body.recurrence) === null || _c === void 0 ? void 0 : _c.push(`UNTIL=${moment(additionalFields.repeatUntil)
                                    .utc()
                    ...
                    if (operation === 'update') {
                        ...
                        if (updateFields.allday && updateFields.start && updateFields.end) {
                            body.start = {
                                date: moment(updateFields.start)
                                    .utc()
                                    .format('YYYY-MM-DD'),
                            };
                            body.end = {
                                date: moment(updateFields.end)
                                    .utc()
                                    .format('YYYY-MM-DD'),
                            };
                        }
                        ...
                        if (updateFields.rrule) {
                            ...
                            if (updateFields.repeatUntil) {
                                (_f = body.recurrence) === null || _f === void 0 ? void 0 : _f.push(`UNTIL=${moment(updateFields.repeatUntil)
                                    .utc()
                                    .format('YYYYMMDDTHHmmss')}Z`);
                            }
                            if (body.recurrence.length !== 0) {
