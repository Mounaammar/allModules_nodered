    ...
    async execute() {
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (mode === 'binaryToJson') {
                ...
                const value = lodash_1.get(item.binary, sourceKey);
                if (value === undefined) {
                    continue;
                }
                ...
                if (setAllData === true) {
                    convertedValue = iconv.decode(Buffer.from(convertedValue, n8n_core_1.BINARY_ENCODING), encoding, { stripBOM: options.stripBOM });
                    ...
                    lodash_1.set(newItem.json, destinationKey, convertedValue);
                }
                if (options.keepSource === true) {
                    ...
                    lodash_1.unset(newItem.binary, sourceKey);
                }
            }
                ...
                if (convertAllData === false) {
                    const sourceKey = this.getNodeParameter('sourceKey', itemIndex);
                    value = lodash_1.get(item.json, sourceKey);
                }
                if (value === undefined) {
                    continue;
                }
                ...
                if (options.dataIsBase64 !== true) {
                    ...
                    value = iconv.encode(value, encoding, { addBOM: options.addBOM }).toString(n8n_core_1.BINARY_ENCODING);
                }
                ...
                lodash_1.set(newItem.binary, destinationKey, convertedValue);
                if (options.keepSource === true) {
                    ...
                    if (convertAllData === true) {
                        ...
                        newItem.json = JSON.parse(JSON.stringify(item.json));
                        const sourceKey = this.getNodeParameter('sourceKey', itemIndex);
                        lodash_1.unset(newItem.json, sourceKey);
                    }
                }
            }
            else {
